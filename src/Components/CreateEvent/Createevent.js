  ...
  return (
    <div className='bg-zinc-100 min-h-screen'>
      ...
      <div className='container w-[800px] mx-auto px-4 py-8'>
        <h1 className='text-2xl font-bold text-gray-800 mb-6 flex justify-center'>Create New Event</h1>

        <form onSubmit={handleSubmit} className='bg-white shadow-lg rounded-2xl p-6 text-gray-800 border border-gray-200'>
          <div className='space-y-4'>
            ...
            <div>
              <label className='block text-gray-700 font-semibold mb-2'>Organized By</label>
              <input
                type='text'
                value={organizedBy}
            ...
            <div>
              <label className='block text-gray-700 font-semibold mb-2'>Join Link</label>
              <input
                type='url'
                value={joinLink}
